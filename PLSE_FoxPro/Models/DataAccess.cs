    ...
    public class EmployeeDataAccess : DataAccess<Employee>
    {
                ...
                if (rd.HasRows)
                {
                    ...
                    while (rd.Read())
                    {
                        list.Add(new Employee(id: rd.GetInt32(colEmployeeID),
                                            departament: App.Me.Storage.DepartamentsAccessService.GetItemByID(rd.GetByte(colDepartament)),
        ...
        private Employee_SlightPart LoadSligthPart(Employee item)
        {
            ...
            try
            {
                ...
                {
                    rd.Read();
                    Adress adress = new Adress(settlement: rd.IsDBNull(7) ? null : App.Me.Storage.SettlementAccessService.GetItemByID(rd.GetInt32(7)),
                ...
                if (rd.HasRows)
                {
                    ...
                    while (rd.Read())
                    {
                        list.Add(new Expert(id: rd.GetInt32(colExpertID),
                                            speciality: App.Me.Storage.SpecialityAccessService.GetItemByID(rd.GetInt16(colSpecialityID)),
                                            employee: App.Me.Storage.EmployeeAccessService.GetItemByID(rd.GetInt32(colEmployeeID)),
        ...
        public override ICollection<Organization> Items()
        {
            ...
            try
            {
                ...
                if (rd.HasRows)
                {
                    ...
                    while (rd.Read())
                    {
                        Adress adr = new Adress(settlement: rd.IsDBNull(colSettlement) ? null : App.Me.Storage.SettlementAccessService.GetItemByID(rd.GetInt32(colSettlement)),
        ...
        public override Laboratory GetItemByID(int id)
        {
            ...
            try
            {
                ...
                if (rd.HasRows)
                {
                    ...
                    while (rd.Read())
                    {
                        Adress _add = new Adress(settlement: App.Me.Storage.SettlementAccessService.GetItemByID(rd.GetInt32(colSettlementID)),
            ...
            try
            {
                ...
                while (rd.Read())
                {
                    resolution = new Resolution(id: rd.GetInt32(0),
                                                ...
                                                typecase: App.Me.Storage.CaseTypes.First(n => n.Code.Equals(rd.GetString(13), StringComparison.Ordinal)),
                    ...
                    while (rd.Read())
                    {
                        ...
                        if (!resols.Any(n => n.ID == resid))
                        {
                            _resolution = new Resolution(
                                                ...
                                                customer: App.Me.Storage.CustomerAccessService.GetItemByID(rd.GetInt32(colCustomerID)),
                                                ...
                                                typecase: App.Me.Storage.CaseTypes.First(n => n.Code.Equals(rd.GetString(colCaseType), StringComparison.Ordinal)),
                        ...
                        if (expid < rd.GetInt32(colExpertiseID)) // sorted
                        {
                            ...
                            _expertise = new Expertise(id: expid,
                                                        ...
                                                        expert: App.Me.Storage.ExpertAccessService.GetItemByID(rd.GetInt32(colExpertID)),
                        ...
                        if (!rd.IsDBNull(colMID))
                        {
                            switch (rd.GetByte(colMType))//1 - Request, 2 - Responce, 3 - Report, 4 - Outcoming Letter, 5 - Incoming Letter
                            {
                                ...
                                case 5:
                                    ...
                                    break;
                                default:
                                    _storage.ErrorReporter.LogError("Unknown type of expertise movement. Movement not created");
                                    break;
                            }
                        }
                    }
                    ...
                    if (rd.NextResult())
                    {
                        while (rd.Read())
                        {
                            EquipmentUsage usage = new EquipmentUsage(id: rd.GetInt32(0),
                                                                        ...
                                                                        equipment: App.Me.Storage.EquipmentAccessService.GetItemByID(rd.GetInt16(1)),
                                                                        version: Version.Original
                                                                        );
        ...
        protected override void Add(ExpertiseMovement item, SqlConnection connection, SqlTransaction tran = null)
        {
            switch (item)
            {
                ...
                case OutcomingLetter l:
                    ...
                    break;
                default:
                    _storage.ErrorReporter.LogError("Unknown type of ExpertiseMovement");
                    break;
            }
        }
